// Transformando mensagem de erro do firebase em PTBR - https://gist.github.com/Albejr/a38cdeac247ef177986c99629680afb4

export default function traduzirErro(errorCode: string): string {
    ...
    switch (errorCode) {
        ...
        case 'auth/email-already-in-use':
            return 'Já existe uma conta com o endereço de e-mail fornecido.';
